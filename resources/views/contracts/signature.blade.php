    ...
    <div class="modal-body" id="">
        <div class="row">
            ...
            <div class="form-control" >
                ...
                <input type="hidden" @if(Auth::user()->type == 'Owner')name="owner_signature" @elseif(Auth::user()->type == 'Client' ) name="client_signature" @endif id="SignupImage1">
            </div>
            <div class="mt-1">
            ...
            this.saveButton = document.getElementById('addSig');
                ...
                this.saveButton.addEventListener('click', function (event) {
                    ...
                    success: function (data) {
                        show_toastr('{{__("Success")}}', 'Contract Signed Successfully', 'success');
