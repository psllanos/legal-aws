...
{{-- <form class="pl-3 pr-3" method="post" id="test_email" action="{{ route('test.email.send') }}">
    @csrf
<div class="modal-body">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" id="email_sending" class="btn  btn-primary">{{__('Send Test Mail')}}</button>
    </div>
</form> --}}
