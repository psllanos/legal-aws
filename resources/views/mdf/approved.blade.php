...
{{ Form::model($mdf, array('route' => array('mdf.payments.approved.store', $mdf->id), 'method' => 'POST')) }}
<div class="modal-body">
    <div class="row">
        <div class="col-6 form-group">
            {{ Form::label('amount', __('Amount'),['class'=>'col-form-label']) }}
            {{ Form::number('amount', ($mdf->amount-$mdf->getFundAmt()), array('class' => 'form-control','required'=>'required','min'=>'0',"step"=>"0.01")) }}
        </div>
        <div class="col-6 form-group">
            {{ Form::label('date', __('Payment Date'),['class'=>'col-form-label']) }}
            {{ Form::date('date', '', array('class' => 'form-control datepicker','required'=>'required')) }}
        </div>
        <div class="col-6 form-group">
