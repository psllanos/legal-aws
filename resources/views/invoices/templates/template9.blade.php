                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-3">
                                        ...
                                        <h3 data-v-7d9d14b5="">{{$usr->invoiceNumberFormat($invoice->invoice_id)}}</h3>
                                        <p data-v-7d9d14b5="">{{$usr->dateFormat($invoice->issue_date)}}</p>
                                    </div>
                                    ...
                                    <div data-v-7d9d14b5="" class="row">
                                        ...
                                        <div data-v-7d9d14b5="" class="col-12" style="padding: 0 0px 0 30px;">
                                            ...
                                            <table data-v-7d9d14b5="" class="summary-table">
                                                ...
                                                <tr data-v-7d9d14b5="">
                                                    <td data-v-7d9d14b5="" class="fwb">{{__('To')}}:</td>
                                                ...
                                                <tr data-v-7d9d14b5="">
                                                    <td data-v-7d9d14b5="" class="fwb">{{__('Deal')}}:</td>
                                                    <td data-v-7d9d14b5="" class="text-right">{{$invoice->deal->name}}</td>
                                                </tr>
                                                <tr data-v-7d9d14b5="">
                                                    <td data-v-7d9d14b5="" class="fwb">{{__('Due Date')}}:</td>
                                                    <td data-v-7d9d14b5="" class="text-right">{{$usr->dateFormat($invoice->due_date)}}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div data-v-7d9d14b5="" class="row">   
                                        ...
                                        <!-- <div data-v-7d9d14b5="" class="col-6">
