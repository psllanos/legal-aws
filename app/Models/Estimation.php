...
class Estimation extends Model
{
    ...
    public function client()
    {
     ...
     public static function clients($client_id)
    {
  ...
  public static function taxs($tax_id)
    ...
    {
        return $this->belongsToMany('App\Models\Product', 'estimation_products', 'estimation_id', 'product_id')->withPivot('id', 'price', 'quantity', 'description');
    }
